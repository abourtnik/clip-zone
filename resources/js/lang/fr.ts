export default {
    ...
    "Clear {date} history": "Effacer l’historique de {date} ?",
    ...
    "Do you want to display your ad before each video ?" : "Afficher votre annonce avant chaque vidéo ?",
