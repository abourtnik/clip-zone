    ...
    <div class="offcanvas-body px-0 pt-0 pb-0">
        <nav class="flex-column flex-shrink-0 bg-white d-flex overflow-auto h-100">
            ...
            <ul class="nav nav-pills flex-column text-center">
                <li class="nav-item">
                    <a
                        @class(['nav-link hover-grey rounded-0 d-flex align-items-center gap-4 bg-primary bg-opacity-25 text-black py-3', 'fw-bold text-primary border-start border-5 border-primary' => URL::current() === route('user.edit')])
