<article class="d-flex flex-wrap flex-sm-nowrap mb-2 position-relative gap-2 suggested_video">
    <a href="{{$video->route}}">
        <div class="position-relative">
            <img class="rounded-4" src="{{$video->thumbnail_url}}" alt="{{$video->title}}">
    ...
    <div>
        <a href="{{$video->route}}" class="d-block fw-bold position-relative text-decoration-none text-black text-sm mb-1" title="{{$video->title}}">{{Str::limit($video->title, 50)}}</a>
