...
@section('content')
    <div class="row">
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Views on my videos</h5>
                    <hr>
                    <div class="d-flex align-items-center justify-content-center gap-4">
                        <i class="fa-solid fa-eye fa-2x"></i>
                        <p class="card-text text-center fs-1">121</p>
                    </div>
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Comments on my videos</h5>
                    <hr>
                    <div class="d-flex align-items-center justify-content-center gap-4">
                        <i class="fa-solid fa-comment fa-2x"></i>
                        <p class="card-text text-center fs-1">{{auth()->user()->videos_comments->count()}}</p>
                    </div>
