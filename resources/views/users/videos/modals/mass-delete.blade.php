    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Permanently delete') }}  <span x-text="selected.length"></span> <span x-text="selected.length === 1 ? 'video' : 'videos'"></span> ?</h5>
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <button @click="$refs.deleteForm.submit()" class="btn btn-danger">
                    ...
                    {{ __('Delete')}} <span x-text="selected.length"></span> <span x-text="selected.length === 1 ? 'video' : 'videos'"></span>
                </button>
            </div>
        </div>
    </div>
